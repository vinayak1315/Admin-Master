...
import { EditBookingCcaTitle } from './BookingComp'
...
const BookingCca3 = () => {
    ...
    return (
        <>
            <HeaderNoSearch title={<EditBookingCcaTitle />} />
                    ...
                    <div className="update_detail">
                        <div className="row">
                            ...
                            <div className="col-lg-5 col-12">
                                <div style={{ fontSize: "18px" }} className="ml-4 text-center"><b>Choose Products for Cancellation</b></div>
