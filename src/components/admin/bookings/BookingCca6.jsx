...
import { BookingCca6Title } from './BookingCcaComp'
...
const BookingCca6 = () => {
    ...
    return (
        <>
            <HeaderNoSearch title={<BookingCca6Title />} />
                                ...
                                <div className="booking_detail mt-3">
                                    <table style={{ width: "100%" }}>
                                        ...
                                        <tr className="booking1_table">
                                            ...
                                            <td>21/01/2021<br /><span className="booking_p">11.00 AM</span></td>
