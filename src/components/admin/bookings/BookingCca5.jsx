...
import { BookingCca5Title } from './BookingCcaComp'
...
const BookingCca5 = () => {
    ...
    return (
        <>
            <HeaderNoSearch title={<BookingCca5Title />} />
                    ...
                    {bookingsData.map(data =>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                ...
                                <div className="bill_details">
                                    <div className="mt-3"><b style={{ color: "#00155A", fontSize: "18px" }}>Cancellation Details</b></div>
                                    <div className="mt-3">
                                        <div className="row">
                                            <div className="col-lg-6" style={{ paddingRight: "20px" }}>
                                                <div className="row">
                                                    <div className="col-lg-3">
                                                        <div style={{ color: "#999999", fontSize: "15px" }}><b>Reason</b></div>
                                                    </div>
                                                    <div className="col-lg-3">
                                                        <div style={{ color: "#5D6186", fontSize: "15px" }}>Wrongly Booked</div>
                                                    </div>
                                                </div>
                                                <div className="row">
                                                    <div className="col-lg-3">
                                                        <div style={{ color: "#999999", fontSize: "15px" }}><b>Products</b></div>
                                                    </div>
                                                    <div className="col-lg-3">
                                                        <div style={{ color: "#5D6186", fontSize: "15px" }}>Seat cover, Android Infotainment & 4 more</div>
                                                    </div>
                                                </div>
                                                <div className="row mb-3">
                                                    <div className="col-lg-3">
                                                        <div style={{ color: "#999999", fontSize: "15px" }}><b>Cancelled by</b></div>
                                                    </div>
                                                    <div className="col-lg-3">
                                                        <div style={{ color: "#5D6186", fontSize: "15px" }}>Amit Kumar at 12.00 AM</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
