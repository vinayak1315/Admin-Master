                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-5 col-12">
                                ...
                                <div className="update_b2">
                                    <div><BsCheckCircleFill style={{ color: "#53BD8C", width: "20px", height: "20px" }} /><span style={{ fontSize: "15px" }} className="ml-3">Return Confirmed</span></div>
                                    <div className="mt-4"><BsCheckCircleFill style={{ color: "#53BD8C", width: "20px", height: "20px" }} /><span style={{ fontSize: "15px" }} className="ml-3">Out for Pick Up</span></div>
                                    <div className="mt-4"><BsCheckCircleFill style={{ color: "#53BD8C", width: "20px", height: "20px" }} /><span style={{ fontSize: "15px" }} className="ml-3">Item Received</span></div>
                                    <div className="mt-4"><BsCircle style={{ color: "#000", width: "20px", height: "20px" }} /><span style={{ fontSize: "15px", color: "#2650D8" }} className="ml-3"><u>Refund Initiated</u></span></div>
                                    <div className="mt-4"><BsCircle style={{ color: "#000", width: "20px", height: "20px" }} /><span style={{ fontSize: "15px", color: "#999999" }} className="ml-3">Refund Successfull</span></div>
