            ...
            <div className="page_reducer">
                <div className="cons_detail">
                    <div className="consdetail_c1 d-flex justify-content-center">
                        ...
                        <div className="status_book d-flex justify-content-end"><b>Status : <span className="blueish">Collecting Requirement</span></b></div>
                    </div>
                                        ...
                                        <div className="cons_d2">
                                            ...
                                            <div>
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-6 col-12">
                                                        <button className="btn btn-greenish" onClick={() => navigate('/consultation/detail')}>Add Services</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 col-12">
                                            <div className="d-flex justify-content-end">
                                                <button className="btn btn-cons-share mr-3" style={{ fontSize: "15px", backgroundColor: "#2650D8" }} onClick={() => navigate()}>Select all</button>
                                                <button className="btn btn-cons-share" style={{ fontSize: "15px", backgroundColor: "#2650D8" }} onClick={() => navigate()}><img src={share} height="20px" width="18px" className="mr-2" />Share</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="cons_d5 mt-2">
                                        <div className="row">
...
export default ConsultationDetail1